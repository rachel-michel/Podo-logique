  ...
  private function initSchema(): void
  {
    ...
    if ($count === 0) {
      $this->pdo->exec("
        ...
        ('equipmentList', 'BAC - barre antéro capitale de décharge de l''hallux'),
        ('equipmentList', 'BAC - barre antéro capitale de décharge des orteils 1-2'),
        ('equipmentList', 'BAC - barre antéro capitale de décharge du 2eme orteil'),
        ('equipmentList', 'BAC - barre antéro capitale de décharge des orteils 2-3'),
        ('equipmentList', 'BAC - barre antéro capitale de décharge des orteils 2-3-4'),
        ('equipmentList', 'BAC - barre antéro capitale de décharge du 3eme orteil'),
        ('equipmentList', 'BAC - barre antéro capitale de décharge des orteils 3-4'),
        ('equipmentList', 'BAC - barre antéro capitale de décharge des orteils 3-4-5'),
        ('equipmentList', 'BAC - barre antéro capitale de décharge du 4eme orteil'),
        ('equipmentList', 'BAC - barre antéro capitale de décharge des orteils 4-5'),
        ('equipmentList', 'BAC - barre antéro capitale de décharge du 5eme orteil'),
